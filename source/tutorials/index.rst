...
:ref:`tutorial-gs-with-docker` introduces using ``docker-compose`` apps.
Next is :ref:`tutorial-creating-first-target` —
learning what a :term:`Target` is through experience is key to using your Factory.
Next you will learn how devices consume Targets with :ref:`tutorial-deploying-first-app`.
