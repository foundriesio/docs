...
With `fioctl`_, we will enable the application "aws-iotsdk" on your device registed with the name **raspberrypi3**. For more information about how to register and enable application, TODO: add this::
