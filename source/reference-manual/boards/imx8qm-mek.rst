...
#. Connect the micro-B end of the supplied USB cable into Debug UART port **J18**.
   Connect the other end of the cable to a host computer.

#. Connect Type-C into USB Type-C port **J17**.
   Connect the other end of the cable to a host computer.

#. Use boot switch (**SW2**) to configure to boot from SDP (``[D1-D6]: 000100``).
