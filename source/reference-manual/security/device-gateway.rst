...
This CA is preloaded to factory devices, so that they can use it to verify the FoundriesFactory web APIs TLS certificates.
...
.. warning::
    ...
    Additionally, we recommend printing the private key of your Root of Trust on paper and storing it in a safe.
...
An X.509 certificate issued to your Factory device at a registration process.
