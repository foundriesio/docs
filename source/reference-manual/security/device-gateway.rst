...
LmP devices connect to OTA services via a :ref:`Device Gateway <ref-ota-architecture>` configured with mutual :term:`TLS`.
A set of digital certificates used to establish trust between Factory devices and a Device Gateway is a Factory Public Key Infrastructure (PKI).
