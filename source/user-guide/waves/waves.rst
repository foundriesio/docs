...
Your production workflow and release strategy depend on your specific use case.
Here, we present two approaches for simple usage.
...
This approach allows granular controls of the fleet and software versions.
It is possible to have multiple stable releases for different usage and versions of the product.
