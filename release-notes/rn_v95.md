...
### New Features
> - Added support for EFI boot firmware updates, including functionality to get/set bootloader control environment variables using the fioefi_setenv and fioefi_printenv utilities.
> - Added new CLI client commands: check, pull, install, and run. These individual commands allow users to pull, install, and apply updates from different contexts.
> - Introduced the --src-dir parameter for the aktualizr-lite CLI client, enabling offline updates.
...
> - Moved the custom SOTA client example from the aktualizr-lite repository to a dedicated repository: https://github.com/foundriesio/sotactl.
